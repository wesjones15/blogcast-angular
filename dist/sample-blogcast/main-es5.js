...
var BlogEntryViewComponent = /** @class */ (function () {
    function BlogEntryViewComponent(route, location, blogService, entryService) {
        this.route = route;
    ...
    BlogEntryViewComponent.prototype.ngOnInit = function () {
        this.getBlog();
        this.getBlogEntry();
    };
    BlogEntryViewComponent.prototype.getBlog = function () {
        var _this = this;
        var id = +this.route.snapshot.paramMap.get('blogId');
        this.blogService.getBlog(id).subscribe(function (blog) { return _this.blog = blog; });
    };
    BlogEntryViewComponent.prototype.getBlogEntry = function () {
        var _this = this;
        var entryId = +this.route.snapshot.paramMap.get('entryId');
        this.entryService.getBlogEntry(entryId).subscribe(function (entry) { return _this.entry = entry; });
    };
    BlogEntryViewComponent.prototype.deleteBlogEntry = function (entryId) {
        this.entryService.deleteBlogEntry(entryId).subscribe();
    };
    BlogEntryViewComponent.prototype.editBlogEntry = function (entry, title, body) {
        var _this = this;
        entry.title = title;
        entry.body = body;
        this.entryService.editBlogEntry(entry).subscribe(function (_) { return _this.flipToggleEdit(); });
    };
    BlogEntryViewComponent.prototype.goBack = function () {
        this.location.go("/blog/" + +this.route.snapshot.paramMap.get('blogId'));
    };
    BlogEntryViewComponent.prototype.flipToggleEdit = function () {
        this.toggleEdit = !this.toggleEdit;
    };
    BlogEntryViewComponent.ctorParameters = function () { return [
...
var BlogFormComponent = /** @class */ (function () {
    function BlogFormComponent(route, location, blogService) {
        this.route = route;
        this.location = location;
        this.blogService = blogService;
        this.currentUser = {
    ...
    BlogFormComponent.prototype.addBlog = function (title, description) {
        var blogToAdd = {
            id: null,
            title: title,
...
var BlogcastHeaderComponent = /** @class */ (function () {
    function BlogcastHeaderComponent() {
    }
    BlogcastHeaderComponent.prototype.ngOnInit = function () {
    };
    ...
    return BlogcastHeaderComponent;
}());
...
var CommentFormComponent = /** @class */ (function () {
    function CommentFormComponent(route, commentService) {
        this.route = route;
    ...
    CommentFormComponent.prototype.addComment = function (body) {
        var comment = {
            id: null,
            body: body,
            createdOn: new Date(),
...
var CommentsViewComponent = /** @class */ (function () {
    function CommentsViewComponent(route, location, commentService) {
        this.route = route;
        this.location = location;
        this.commentService = commentService;
        this.comments = [];
    ...
    CommentsViewComponent.prototype.ngOnInit = function () {
        this.getComments();
    };
    CommentsViewComponent.prototype.getComments = function () {
        var _this = this;
        var entryId = +this.route.snapshot.paramMap.get('entryId');
        this.commentService.getCommentsByEntryId(entryId).subscribe(function (comments) { return _this.comments = comments; });
    };
    CommentsViewComponent.prototype.deleteComment = function (commentId) {
        var _this = this;
        this.commentService.deleteComment(commentId).subscribe(function (_) { return _this.getComments(); });
    };
    CommentsViewComponent.prototype.editComment = function (comment, body) {
        comment.body = body;
        this.commentService.editComment(comment).subscribe();
    };
    CommentsViewComponent.prototype.setEditCommentId = function (commentId) {
        this.editCommentId = commentId;
    };
    CommentsViewComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        { type: _angular_common__WEBPACK_IMPORTED_MODULE_3__["Location"] },
...
var EntriesViewComponent = /** @class */ (function () {
    function EntriesViewComponent(route, entryService) {
        this.route = route;
        this.entryService = entryService;
        this.entries = [];
        this.blogId = +this.route.snapshot.paramMap.get('blogId');
    }
    EntriesViewComponent.prototype.ngOnInit = function () {
        this.getBlogEntries();
    };
    EntriesViewComponent.prototype.getBlogEntries = function () {
        var _this = this;
        this.entryService.getBlogEntriesByBlogId(this.blogId).subscribe(function (entries) { return _this.entries = entries; });
    };
    EntriesViewComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
...
var EntryFormComponent = /** @class */ (function () {
    function EntryFormComponent(route, location, entryService) {
        this.route = route;
        this.location = location;
        this.entryService = entryService;
        this.currentUser = {
    ...
    EntryFormComponent.prototype.addBlogEntry = function (title, body) {
        var entry = {
            id: null,
    ...
    EntryFormComponent.prototype.goBack = function () {
        this.location.go("/blog/" + +this.route.snapshot.paramMap.get('blogId'));
    };
...
var BlogEntryService = /** @class */ (function () {
    function BlogEntryService(http, messageService) {
        this.http = http;
        this.messageService = messageService;
        this.httpOptions = {
    ...
    BlogEntryService.prototype.log = function (message) {
        this.messageService.add("BlogService: " + message);
    };
    BlogEntryService.prototype.handleError = function (operation, result) {
        var _this = this;
    ...
    BlogEntryService.prototype.getBlogEntriesByBlogId = function (blogId) {
        var _this = this;
        return this.http.get(this.entryUrl + "/blog/" + blogId, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log('fetched blog entries'); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getBlogEntriesByBlogId', [])));
    };
    BlogEntryService.prototype.getBlogEntry = function (entryId) {
        var _this = this;
        return this.http.get(this.entryUrl + "/" + entryId, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log("fetched blog entry id=" + entryId); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError("getBlogEntry id=" + entryId)));
    };
    BlogEntryService.prototype.addBlogEntry = function (blogEntry) {
        var _this = this;
        return this.http.post(this.entryUrl, blogEntry, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log('added new blog entry'); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('addBlogEntry: failed to add blog entry')));
    };
    BlogEntryService.prototype.editBlogEntry = function (blogEntry) {
        var _this = this;
        return this.http.put(this.entryUrl + "/" + blogEntry.id, blogEntry, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log("updated blog entry with id=" + blogEntry.id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('editBlogEntry failed to update blog entry')));
    };
    BlogEntryService.prototype.deleteBlogEntry = function (entryId) {
        var _this = this;
        return this.http.delete(this.entryUrl + "/" + entryId, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log("deleted blog entry with id=" + entryId); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('deleteBlogEntry failed to delete blog entry')));
    };
    BlogEntryService.ctorParameters = function () { return [
...
var BlogService = /** @class */ (function () {
    function BlogService(http, messageService) {
        this.http = http;
        this.messageService = messageService;
        this.httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
    ...
    BlogService.prototype.log = function (message) {
        this.messageService.add("BlogService: " + message);
    };
    ...
    BlogService.prototype.getBlogs = function () {
        var _this = this;
        return this.http.get(this.blogUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log('fetched blogs'); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getBlogs', [])));
    };
    BlogService.prototype.getBlog = function (id) {
        var _this = this;
        var url = this.blogUrl + "/" + id;
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log("fetched blog id=" + id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError("getBlog id=" + id)));
    };
    BlogService.prototype.addBlog = function (blog) {
        var _this = this;
        return this.http.post(this.blogUrl, blog, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (newBlog) { return _this.log('created new blog'); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('addBlog')));
    };
    BlogService.prototype.updateBlog = function (blog) {
        var _this = this;
        return this.http.put(this.blogUrl, blog, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log("updated blog id=" + blog.id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('updateBlog')));
    };
    BlogService.prototype.deleteBlog = function (blog) {
        var _this = this;
        var id = typeof blog === 'number' ? blog : blog.id;
        var url = this.blogUrl + "/" + id;
        return this.http.delete(url, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log("deleted blog id=" + id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('deleteBlog')));
    };
...
var CommentService = /** @class */ (function () {
    function CommentService(http, messageService) {
        this.http = http;
        this.messageService = messageService;
        this.httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
    ...
    CommentService.prototype.getCommentsByEntryId = function (entryId) {
        var _this = this;
        return this.http.get(this.commentUrl + "/entry/" + entryId, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log("fetched comments for blog entry id=" + entryId); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getCommentsByEntryId', [])));
    };
    CommentService.prototype.getComment = function (commentId) {
        var _this = this;
        return this.http.get(this.commentUrl + "/" + commentId, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log("fetched comment id=" + commentId); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError("getComment id=" + commentId)));
    };
    CommentService.prototype.addComment = function (comment) {
        var _this = this;
        return this.http.post(this.commentUrl, comment, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log('posted comment'); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('comment failed to post')));
    };
    CommentService.prototype.editComment = function (comment) {
        var _this = this;
        return this.http.put(this.commentUrl + "/" + comment.id, comment, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log("updated comment with id=" + comment.id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('editBlogEntry failed to update blog entry')));
    };
    CommentService.prototype.deleteComment = function (commentId) {
        var _this = this;
        return this.http.delete(this.commentUrl + "/" + commentId, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log("deleted comment with id=" + commentId); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('deleteComment failed to delete comment')));
    };
